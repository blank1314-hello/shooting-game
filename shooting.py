def gun():
    ...
    fire2_image = pygame.image.load("C:\Users\user\Desktop\folder\python\complete\image\fire2.png")
    fire2_rect = fire2_image.get_rect()
    fire2_rect.centerx = 1000
    fire2_rect.bottom = 1000

    fire3_image = pygame.image.load("C:\Users\user\Desktop\folder\python\complete\image\fire3.png")
    fire3_rect = fire3_image.get_rect()
    fire3_rect.centerx = 1000
    fire3_rect.bottom = 1000

    cat_image = pygame.image.load("C:\Users\user\Desktop\folder\python\complete\image\cat.png")
    cat_rect = cat_image.get_rect(center=(850, random.randint(0, windows_height)))

    banana_image = pygame.image.load("C:\Users\user\Desktop\folder\python\complete\image\banana.png")
